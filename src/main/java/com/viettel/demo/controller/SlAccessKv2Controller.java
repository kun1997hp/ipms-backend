...
import com.viettel.demo.service.SlAccessKv2Service;
...
@RestController
@RequestMapping("/sl-access-kv2")
public class SlAccessKv2Controller {
    @Autowired
    private SlAccessKv2Service slAccessKv2Service;

    @Autowired
    private SuccessMessage successMessage;

    @GetMapping("/v1")
    public ResponseEntity<DataTableResponse> getSlAccessKv2V1(
            @And({
                    ...
                    //date
                    //date
            }) Specification<SlAccessKv2> specs, Pageable pageable) {
        DataTable dataTable = slAccessKv2Service.findAllPagingAndSorting(specs, pageable);
