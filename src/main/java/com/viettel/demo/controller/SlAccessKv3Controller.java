...
import com.viettel.demo.service.SlAccessKv3Service;
...
@RestController
@RequestMapping("/sl-access-kv3")
public class SlAccessKv3Controller {
    @Autowired
    private SlAccessKv3Service slAccessKv3Service;

    @Autowired
    private SuccessMessage successMessage;

    @GetMapping("/v1")
    public ResponseEntity<DataTableResponse> getSlAccessKv3V1(
            @And({
                    ...
                    //date
                    //date
            }) Specification<SlAccessKv3> specs, Pageable pageable) {
        DataTable dataTable = slAccessKv3Service.findAllPagingAndSorting(specs, pageable);
