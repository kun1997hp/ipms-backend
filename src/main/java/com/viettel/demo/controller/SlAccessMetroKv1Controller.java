...
import com.viettel.demo.service.SlAccessMetroKv1Service;
...
@RestController
@RequestMapping("/sl-access-metro-kv1")
public class SlAccessMetroKv1Controller {
    @Autowired
    private SlAccessMetroKv1Service slAccessMetroKv1Service;

    @Autowired
    private SuccessMessage successMessage;

    @GetMapping("/v1")
    public ResponseEntity<DataTableResponse> getSlAccessMetroKv1V1(
            @And({
                    ...
                    //date
                    //date
            }) Specification<SlAccessMetroKv1> specs, Pageable pageable) {
        DataTable dataTable = slAccessMetroKv1Service.findAllPagingAndSorting(specs, pageable);
