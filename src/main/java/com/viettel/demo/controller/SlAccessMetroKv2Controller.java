...
import com.viettel.demo.service.SlAccessMetroKv2Service;
...
@RestController
@RequestMapping("/sl-access-metro-kv2")
public class SlAccessMetroKv2Controller {
    @Autowired
    private SlAccessMetroKv2Service slAccessMetroKv2Service;

    @Autowired
    private SuccessMessage successMessage;

    @GetMapping("/v1")
    public ResponseEntity<DataTableResponse> getSlAccessMetroKv2V1(
            @And({
                    ...
                    //date
                    //date
            }) Specification<SlAccessMetroKv2> specs, Pageable pageable) {
        DataTable dataTable = slAccessMetroKv2Service.findAllPagingAndSorting(specs, pageable);
