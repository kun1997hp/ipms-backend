...
import com.viettel.demo.service.SlAccessMetroKv3Service;
...
@RestController
@RequestMapping("/sl-access-metro-kv3")
public class SlAccessMetroKv3Controller {
    @Autowired
    private SlAccessMetroKv3Service slAccessMetroKv3Service;

    @Autowired
    private SuccessMessage successMessage;

    @GetMapping("/v1")
    public ResponseEntity<DataTableResponse> getSlAccessMetroKv3V1(
            @And({
                    ...
                    //date
                    //date
            }) Specification<SlAccessMetroKv3> specs, Pageable pageable) {
        DataTable dataTable = slAccessMetroKv3Service.findAllPagingAndSorting(specs, pageable);
