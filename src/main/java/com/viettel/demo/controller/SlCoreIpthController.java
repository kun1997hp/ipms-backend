...
import com.viettel.demo.service.SlCoreIpthService;
...
@RestController
@RequestMapping("/sl-core-ipth")
public class SlCoreIpthController {
    @Autowired
    private SlCoreIpthService slCoreIpthService;

    @Autowired
    private SuccessMessage successMessage;

    @GetMapping("/v1")
    public ResponseEntity<DataTableResponse> getSlCoreIpthV1(
            @And({
                    ...
                    //date
                    //date
            }) Specification<SlCoreIpth> specs, Pageable pageable) {
        DataTable dataTable = slCoreIpthService.findAllPagingAndSorting(specs, pageable);
