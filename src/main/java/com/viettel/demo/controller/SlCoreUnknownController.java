...
import com.viettel.demo.service.SlCoreUnknownService;
...
@RestController
@RequestMapping("/sl-core-unknown")
public class SlCoreUnknownController {
    @Autowired
    private SlCoreUnknownService slCoreUnknownService;

    @Autowired
    private SuccessMessage successMessage;

    @GetMapping("/v1")
    public ResponseEntity<DataTableResponse> getSlCoreUnknownV1(
            @And({
                    ...
                    //date
                    //date
            }) Specification<SlCoreUnknown> specs, Pageable pageable) {
        DataTable dataTable = slCoreUnknownService.findAllPagingAndSorting(specs, pageable);
