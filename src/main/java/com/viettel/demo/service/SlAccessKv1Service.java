...
@Service
public class SlAccessKv1Service {
    @Autowired
    private SlAccessKv1Repository slAccessKv1Repository;
    ...
    public DataTable findAllPagingAndSorting(Specification<SlAccessKv1> specs, Pageable pageable){
        Page<SlAccessKv1> slAccessKv1s = slAccessKv1Repository.findAll(specs, pageable);
        return new DataTable(slAccessKv1s);
    }
}
