...
@Service
public class SlAccessKv2Service {
    @Autowired
    private SlAccessKv2Repository slAccessKv2Repository;
    ...
    public DataTable findAllPagingAndSorting(Specification<SlAccessKv2> specs, Pageable pageable){
        Page<SlAccessKv2> slAccessKv2s = slAccessKv2Repository.findAll(specs, pageable);
        return new DataTable(slAccessKv2s);
    }
}
