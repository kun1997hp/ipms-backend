...
@Service
public class SlAccessKv3Service {
    @Autowired
    private SlAccessKv3Repository slAccessKv3Repository;
    ...
    public DataTable findAllPagingAndSorting(Specification<SlAccessKv3> specs, Pageable pageable){
        Page<SlAccessKv3> slAccessKv3s = slAccessKv3Repository.findAll(specs, pageable);
        return new DataTable(slAccessKv3s);
    }
}
