...
@Service
public class SlAccessMetroKv2Service {
    @Autowired
    private SlAccessMetroKv2Repository slAccessMetroKv2Repository;
    ...
    public DataTable findAllPagingAndSorting(Specification<SlAccessMetroKv2> specs, Pageable pageable){
        Page<SlAccessMetroKv2> slAccessMetroKv2s = slAccessMetroKv2Repository.findAll(specs, pageable);
        return new DataTable(slAccessMetroKv2s);
    }
}
