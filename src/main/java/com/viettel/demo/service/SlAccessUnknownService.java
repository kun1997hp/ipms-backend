...
@Service
public class SlAccessUnknownService {
    @Autowired
    private SlAccessUnknownRepository slAccessUnknownRepository;
    ...
    public DataTable findAllPagingAndSorting(Specification<SlAccessUnknown> specs, Pageable pageable){
        Page<SlAccessUnknown> slAccessUnknowns = slAccessUnknownRepository.findAll(specs, pageable);
        return new DataTable(slAccessUnknowns);
    }
}
