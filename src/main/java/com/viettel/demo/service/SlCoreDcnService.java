...
@Service
public class SlCoreDcnService {
    @Autowired
    private SlCoreDcnRepository slCoreDcnRepository;
    ...
    public DataTable findAllPagingAndSorting(Specification<SlCoreDcn> specs, Pageable pageable){
        Page<SlCoreDcn> slCoreDcns = slCoreDcnRepository.findAll(specs, pageable);
        return new DataTable(slCoreDcns);
    }
}
