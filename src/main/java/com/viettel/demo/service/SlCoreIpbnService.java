...
@Service
public class SlCoreIpbnService {
    @Autowired
    private SlCoreIpbnRepository slCoreIpbnRepository;
    ...
    public DataTable findAllPagingAndSorting(Specification<SlCoreIpbn> specs, Pageable pageable){
        Page<SlCoreIpbn> slCoreIpbns = slCoreIpbnRepository.findAll(specs, pageable);
        return new DataTable(slCoreIpbns);
    }
}
