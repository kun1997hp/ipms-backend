...
@Service
public class SlCoreIpthService {
    @Autowired
    private SlCoreIpthRepository slCoreIpthRepository;
    ...
    public DataTable findAllPagingAndSorting(Specification<SlCoreIpth> specs, Pageable pageable){
        Page<SlCoreIpth> slCoreIpths = slCoreIpthRepository.findAll(specs, pageable);
        return new DataTable(slCoreIpths);
    }
}
