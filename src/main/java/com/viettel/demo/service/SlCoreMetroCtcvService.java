...
@Service
public class SlCoreMetroCtcvService {
    @Autowired
    private SlCoreMetroCtcvRepository slCoreMetroCtcvRepository;
    ...
    public DataTable findAllPagingAndSorting(Specification<SlCoreMetroCtcv> specs, Pageable pageable){
        Page<SlCoreMetroCtcv> slCoreMetroCtcvs = slCoreMetroCtcvRepository.findAll(specs, pageable);
        return new DataTable(slCoreMetroCtcvs);
    }
}
