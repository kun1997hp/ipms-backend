...
@Service
public class SlCoreUnknownService {
    @Autowired
    private SlCoreUnknownRepository slCoreUnknownRepository;
    ...
    public DataTable findAllPagingAndSorting(Specification<SlCoreUnknown> specs, Pageable pageable){
        Page<SlCoreUnknown> slCoreUnknowns = slCoreUnknownRepository.findAll(specs, pageable);
        return new DataTable(slCoreUnknowns);
    }
}
